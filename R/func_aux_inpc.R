...
# utilizando o api da SIDRA
coletando_inpc_api <- function(){
  ...
  base_Tratada <- base_Tratada %>% as.data.table()
  base_Tratada <- base_Tratada[, c("Valor", "Mês")]
  setnames(base_Tratada, c("Valor","Mês"), c("inpc","meses"))
